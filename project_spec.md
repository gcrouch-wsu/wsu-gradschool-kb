...
* Admin auth using bootstrap owner and managed users
* CSRF protection
* Login and search rate limiting
* Owner/admin/editor role model
* KB model and KB assignments
* User and KB user assignment tables
* One developer/config-managed KB template
* Reserved-slug validation
* Basic audit log plumbing

### Phase 1: Public Read Path with Fixtures
...
* Basic navigation
* Public KB-scoped search using Postgres FTS
* Accessible public chrome
...
### Phase 3: Editor and Draft/Published Separation

Add:

* Final editor library selection
* Documented block schema
* Controlled WYSIWYG/block editor
...
### Phase 4: Publishing, Versions, Locks, Redirects, and Aliases
...
### Phase 5: Shared Assets and Export
...
* Single DOCX import into staging
* Staged media review
* Staged import commit to draft
* Markdown import
* Redirect CSV import into staging

### Phase 7: Review Tools and Better Search
...
* Basic page tree
* Public KB-scoped search
* Admin login using existing custom admin model
* CSRF protection and rate limiting
* Owner/admin/editor roles
* KB assignment permissions
* Page editor with approved accessible components
...
Start with a focused pilot, not a full migration.
...
* Public KB shell
* Five to ten migrated pages
* File/image manager
* Direct-to-blob upload
* Stream-first stable asset routes
* Stable asset replacement
* Asset usage tracking
* Single DOCX import staging
* Basic search
* Admin editor
* KB export bundle
