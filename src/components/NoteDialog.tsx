        ...
        <div className="media-picker__body form">
          <label>
            ...
            <textarea
              ...
              placeholder="Leave a comment about the highlighted text…"
              rows={4}
              value={body}
            />
          </label>
          <p className="meta">Like a Word comment: it points to the highlighted text and is removed before publishing.</p>
